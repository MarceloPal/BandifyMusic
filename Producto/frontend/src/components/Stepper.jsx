...
export default function Stepper({
  ...
  disableFinalStep = false,   // bloquea "Finalizar" hasta que la condición externa se cumpla
  renderStepIndicator,
  ...rest
}) {
          ...
          <div className={`footer-container ${footerClassName}`}>
            <div className={`footer-nav ${currentStep !== 1 ? 'spread' : 'end'}`}>
              ...
              <button
                ...
                disabled={isLastStep && disableFinalStep}
                style={isLastStep && disableFinalStep
