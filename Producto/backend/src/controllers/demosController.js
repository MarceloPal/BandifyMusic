/**
 * Controlador de Demos — gestión del repertorio de tracks del usuario.
 * Las queries SQL se mantienen idénticas al código original.
 */
 ...
 * Parsea audio_vector (pgvector → array JS) y audio_metadata (JSONB).
 */
...
/**
 * PUT /demos/:id — actualiza nombre y/o cover_url del demo.
 * Verifica propiedad del demo antes de actualizar.
 */
