/**
 * Notificaciones — agregadas en tiempo real desde tablas existentes.
 *
 * Tipos:
 ...
 *
 * No requiere tabla de notificaciones. Cada llamada calcula sobre el estado actual.
 */
...
// PATCH /notificaciones/leer — marca todas las notificaciones de mensajes como leídas
router.patch('/leer', authMiddleware, async (req, res, next) => {
  try {
    await pool.query(
